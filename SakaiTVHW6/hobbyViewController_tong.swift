...
class hobbyViewController: UIViewController {
    ...
    func createmontains(width: CGFloat, height: CGFloat, position: CGPoint) -> [CGPath] {
    ...
    override func viewDidLoad() {
        ...
        let cloudtoright = clouds_toRight()
        cloudtoright.frame = CGRect(x: -100, y: 50, width: 100, height: 150)
        //        cloud.center
        cloudtoright.backgroundColor = UIColor(white: 1, alpha: 0.0)
